...
<header class="bg-black border-b-4 border-yellow-400 shadow-md py-4">
    <div class="container mx-auto flex justify-center">
        <img src="<?php echo e(asset('images/logo.jpg')); ?>" alt="ECUPÁDEL CLUB Logo" class="h-32 w-auto">
    </div>
</header>
    ...
    <footer class="bg-black text-white py-6">
        <div class="container mx-auto text-center">
            <p>&copy; <?php echo e(date('Y')); ?> ECUPÁDEL CLUB. Todos los derechos reservados.</p>
...
<?php /**PATH C:\laragon\www\ecupadel\public\resources\views/welcome.blade.php ENDPATH**/ ?>